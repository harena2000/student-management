...
const navigation = [
    { name: 'Dashboard', href: '/dashboard', current: page.component.valueOf() == "Student/Dashboard" },
    { name: 'Class', href: '/classes', current: page.component.valueOf() == "Class/ClassesList" },
